...
public class HostUrlsTests
{
    ...
    [InlineData("https://example.com/y", "192.168.1.5", "https://example.com/y")]
    [InlineData("http://localhostings:80", "1.2.3.4", "http://localhostings:80")]
    ...
    [InlineData("https://app.example.com", "192.168.178.63", "https://app.example.com")]
