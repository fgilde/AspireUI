...
public class CatalogTests
{
    ...
    {
        // Nextended.Aspire.Hosting.AspireUI (AddAspireUI) — AspireUI itself as a resource. Force-loaded
        // in LoadDefault; grouped under "AspireUI" so the palette pins it first.
        var cat = new CatalogService().GetCatalog();
    ...
    {
        // CommunityToolkit.Aspire.Hosting.Ollama (13.4.0) and Nextended.Aspire (10.1.17) are
