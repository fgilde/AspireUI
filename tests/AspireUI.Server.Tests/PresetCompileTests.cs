...
// Tests that companion-preset code shape compiles without errors.
    ...
    public void CompanionPresetShape_CompilesWithZeroErrors()
    {
        var main = new NodeModel("n1", "immich", "AddContainer", "immich",
            [
                ...
                new WithCall("WithEnvironment", ["\"DB_HOSTNAME\"", "\"immich-db\""]),
        ...
        Assert.DoesNotContain(".WithReference(", code);
