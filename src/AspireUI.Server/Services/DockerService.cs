...
// Read/housekeep Docker artifacts (dev-run, hosting); lets user see and prune; protects AspireUI's container/data.
public class DockerService(DeployService deploy)
{
    ...
    // Prune dangling images/stopped containers only; not volumes (would delete app data).
